        ...
        while len(groups) < num_groups:
            ...
            for item, num_ratings in pos_group_rating_counter.items():
                if num_ratings == len(group):
                    ...
                    #print("informações")
                    #print(timestamp)
                    #print(group_rated_items)
                    #print(group_rating_list)
            ...
            #    print(pos_group_rating_counter.items())
            #    print(neg_group_rating_counter.items())
            #    print(len(group_rating_list))
...
if __name__ == '__main__':
    ...
    #data_zip_path = '../data/MovieLens-1M.zip'
